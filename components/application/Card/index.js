...
export default function Card({
  ...
  // See https://github.com/clauderic/dnd-kit/issues/317#issuecomment-856288716
  ...
  return (
    <>
            ...
            <Box>
              ...
              >
                <Flipped
                  ...
                  delayUntil={flipId}
                >
                  <Heading as="h4" size="sm" noOfLines={1} title={title}>
                    {renderTitle(title)}
                  </Heading>
                </Flipped>
                <Flipped
                  ...
                  >
                    {screenSize !== "small" && (
                      <VariableButton
                        ...
                        text={formatMessage({ id: "full_screen" })}
                        Icon={ZoomIn}
      ...
      >
        <DrawerOverlay>
          <DrawerContent>
            <DrawerCloseButton background="whiteAlpha.200" color="white" />
